...
const defaultSettings = {
    ...
    tableStructure: [
        {
            tableName: "时间管理", tableIndex: 0, columns: ['日期', '时间', '地点（当前描写）', '场景角色'], columnsIndex: [0, 1, 2, 3], enable: true, Required: true, asStatus: true, toChat: true, note: "记录时间管理的表格，应保持在一行，并实时更新",
            initNode: '本轮需要记录当前时间、地点、人物信息，使用insertRow函数', updateNode: "当描写的场景，时间，人物变更时", deleteNode: "此表大于一行时应删除多余行"
        },
        {
            tableName: '角色特征表格', tableIndex: 1, columns: ['角色名', '身体特征', '性格', '职业', '爱好', '喜欢的事物（作品、虚拟人物、物品等）', '住所', '其他重要信息'], enable: true, Required: true, asStatus: true, toChat: true, columnsIndex: [0, 1, 2, 3, 4, 5, 6, 7], note: '角色天生或不易改变的特征csv表格，思考本轮有否有其中的角色，他应按照人物设定作出什么反应',
    ...
    to_chat_container: `<div class="table-preview-bar"><details> <summary>记忆格</summary>
$0
</details></div>
...
`,
    refresh_system_message_template: `你是名叫aw的专业的表格整理助手，请严格按照{{user}}的指令和格式要求处理表格数据。`,
...
<整理规则>
    ...
    5. "时间管理"(tableIndex: 0）只允许有一行，删除所有旧的内容，此操作只允许整行操作！
    ...
    12. 表格内容需要根据人物设定以及上下文聊天记录整理，尽可能确保详尽准确
</整理规则>
