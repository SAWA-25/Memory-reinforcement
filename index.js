...
const defaultSettings = {
    ...
    tableStructure: [
        {
            tableName: "时间管理", tableIndex: 0, columns: ['日期', '时间', '地点（当前描写）', '此地角色'], columnsIndex: [0, 1, 2, 3], enable: true, Required: true, asStatus: true, toChat: true, note: "记录时间管理的表格，应保持在一行",
    ...
    to_chat_container: `<div class="table-preview-bar"><details> <summary>记忆强化</summary>
$0
</details></div>
...
`,
    refresh_system_message_template: `你是叫做aw的专业的表格整理助手，请严格按照{{user}}的指令和格式要求处理表格数据。`,
